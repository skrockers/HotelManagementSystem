...
<div class="container-fluid" id="main">
	...
	<form action="CustSession.jsp" method="post">
		...
		<div class="form-group" id="submithover">
			...
			%></h5>
			<p><b>or Don't have any Account?<a href="CustReg.jsp" class="text-danger">Register Now</a></b></p>
		</div><br>
			</form>
			
	</div><br><br><br><br>

	<div class="footer-copyright bg-warning text-center" style="background-color:ffff56;">
	<h5 class="text-dark">SKHOTELS</h5>
	© 2020 BY SK HOTELS | ALL RIGHTS RESERVED</div>
</div>
</body>
</html>