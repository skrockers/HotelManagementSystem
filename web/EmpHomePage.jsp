...
<div class="container-fluid" id="main">
							...
							<div class="collapse navbar-collapse" id="navbarid">
									<ul class="navbar-nav text-center"  id="ulhover">
									    ...
									    <li class="nav-item"><a class="nav-link" href="#">SIGNUP</a></li>
									      ...
									      %></a></li>
									       <li class="nav-item"><a class="nav-link" href="EmpLog.jsp">LogOut</a></li>
									</ul>
							</div>
		</div><!-- nav-container -->
	</nav><br>
    ...
    String query="select *from empregister where Name=? and Password=?";
  ...
  else
  {
      ...
      out.println("location='EmpLog.jsp';");
      out.println("</script>");
  }
}
catch(Exception e)
