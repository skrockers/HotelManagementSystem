...
<title>Normal Room Assigned</title>
...
<% 
String bookdate=request.getParameter("reqn1");
String name=request.getParameter("reqn2");
String email=request.getParameter("reqn3");
String contact=request.getParameter("reqn4");
String roomcount=request.getParameter("reqn5");
String roomtype=request.getParameter("reqn6");
String checkin=request.getParameter("reqn7");
String checkout=request.getParameter("reqn8");
String requestid=request.getParameter("reqn9");
String roomno=request.getParameter("reqn10");
String roomid=request.getParameter("reqn11");
String roomtypes=request.getParameter("reqn12");
...
if(count1==1)
{
	String del="delete from custreservations where Request_ID=?";
	 ...
	 if(count2==1)
	 {
		 String delroom="delete from addnormal where RoomNo=?";
	 ...
	 session.setAttribute("roomsg2",roommsg);
	 response.sendRedirect("AssignNormal.jsp");
}
else
{
	session.setAttribute("noroomsg2","Something gone wrong.....");
	 response.sendRedirect("AssignNormal.jsp");
}
