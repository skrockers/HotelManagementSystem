...
String query="select *from addnormal";
	...
	<%while(rs.next())
			{ %>
				<tr class="card bg-primary"style="border-radius:10px 50px;float:right;width:150px;height:100px;margin-top:50px;margin-left:50px;">
					...
					<td><a class="btn btn-success "style="margin-left:20px;height:40px;"href="AssignNormal.jsp">Assign</a><%} %> </td>					
				</tr>
