...
<div class="container-fluid" id="main">
	...
	try
	{	
	String notfound=session.getAttribute("notfounds").toString();
	
	%>
	<div class="alert alert-danger">
	<strong>Error occured..!!!</strong>	<%out.print(notfound); %>
	<%session.removeAttribute("notfounds"); %>
	</div>
	<%
	}catch(Exception e){}
	%>
	...
	try
	{	
	String found=session.getAttribute("founds").toString();
	
	%>
	<div class="alert alert-success">
	<strong>Success.!!!</strong>	<%out.print(found); %>
	<%session.removeAttribute("founds"); %>
		</div>
	<%
	}catch(Exception e){}
	%>
...
<h1>View Records</h1><br><br>
<a  href="AdminHomePage.jsp" style="margin-top:-20px;margin-left:1000px;"class="btn btn-primary">Back</a>
	<form  class="form-inline"action="RecordSearch.jsp" method="post"><br>
	<label style="margin-left:100px;"><h4>Request-ID:</h4></label>
		<input type="text" style="width:300px;margin-left:100px;" name="recordsearch" class="form-control">
...
<%
	...
	String querys="select * from OldRecords";
...
%>	
	...
	<tr>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr1").toString()); %></h6></td>
		<td style="width:200px;" class="text-center"><h6><%out.print(session.getAttribute("sr2").toString()); %></h6></td>
		<td style="width:200px;" class="text-center"><h6><%out.print(session.getAttribute("sr3").toString()); %></h6></td>
		<td style="width:200px;" class="text-center"><h6><%out.print(session.getAttribute("sr4").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr5").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr6").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr7").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr8").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr9").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr10").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr11").toString()); %></h6></td>
		<td style="width:200px;"class="text-center"><h6><%out.print(session.getAttribute("sr12").toString()); %></h6></td>
		<%session.removeAttribute("sr1");
		session.removeAttribute("sr2");
		session.removeAttribute("sr3");
		session.removeAttribute("sr4");
		session.removeAttribute("sr5");
		session.removeAttribute("sr6");
		session.removeAttribute("sr7");
		session.removeAttribute("sr8");
		session.removeAttribute("sr9");
		session.removeAttribute("sr10");
		session.removeAttribute("sr11");
		session.removeAttribute("sr12");
 %>
		</tr>
	</table>
<%}catch(Exception e){} %>	
