...
<div class="container-fluid" id="main">
	...
	<h1>Manager Registration Success!!!!</h1>
<p>Registration Done successfully.You can Login now with your Username <a href="#"><%out.println(Name); %></a> and Password.<a class="text-danger" href="ManLog.jsp">Login Now</a></p>
	<br>
	<br>
	<br>
    ...
    String add_query="insert into manregister(Name,Password,Confirm,Email,ContactNo) values(?,?,?,?,?)";
   ...
   /*  out.println("<script type=\"text/javascript\">");
    ...
    response.sendRedirect("ManReg.jsp");
}
catch(Exception e)
{
